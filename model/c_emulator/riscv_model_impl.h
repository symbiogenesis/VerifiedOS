...
private:
  ...
  unit xreg_full_write_callback(const_sail_string abi_name, sbits reg, uint64_t value, bool tag) override;
  unit scr_full_write_callback(const_sail_string name, fbits scr, uint64_t value, bool tag) override;
