...
Being neither a GUI nor a JIT host, gitoxide clears obstacles 2 and 4 for free; what remains is the subtraction of ambient authority — the coreutils shape — now joined by a move the coreutils lift has no analogue for: collapsing Git's bespoke object store onto the verified §10 store.
