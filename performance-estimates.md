...
| Memory-bound streaming | **−30% to −55%** | Integrity tree + no-prefetch + bank partitioning, softened by no-MMU and SRAM's lower base latency; the absence of a data cache is a non-factor here (streaming defeats caches anyway). |
