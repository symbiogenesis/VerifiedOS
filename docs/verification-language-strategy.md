...
| [Katamaran](https://github.com/katamaran-project/katamaran) and [Islaris](https://github.com/rems-project/islaris) | Q2b: machine-connection comparison; Q3b: accepted slice evidence | Contract-based symbolic execution and instruction-trace reasoning are relevant existing machinery. Pinned Sail meaning, translation/trace soundness and compatibility must be established, not inferred from another architecture's example. Morello-Cerise is architectural precedent, not a CHERI-RISC-V library instance. |
