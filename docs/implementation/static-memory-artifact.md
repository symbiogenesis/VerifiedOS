...
| [Deletion-parameter structure](static-memory-structure.md) | peer-reviewed result cited; elementary argument in prose; bounded executable evidence | The cited overlap-graph result, local parameter and bipartite arguments, and finite decomposition counterexamples have separate scopes |
