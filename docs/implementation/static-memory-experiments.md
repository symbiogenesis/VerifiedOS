...
release-to-reuse intervals. It records the charged live-load lower bound,
feasible span, remaining gap and search work separately for each arena.
...
that evidence independently. Its own work budget can expire, leaving replay
