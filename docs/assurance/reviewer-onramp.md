...
- **The letter-suffix density is high, and that is a signal rather than a defect.** 478 of the register's 1431 entries are post-hoc insertions, which is evidence about edit rate against review stability. [critique.md](../background/critique.md) reads it that way and does not charge it as an error.
