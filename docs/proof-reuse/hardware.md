...
and [implementation checklist](../implementation-checklist.md) own the current
...
| Capability safety and adversarial code, R-13-016/R-13-017, CJ-CERISE | The canonical Sail connection, universal contract and concrete memory laws remain the foundation work identified in the [foundation map](../cheri-foundation-map.md). | HW-03, HW-04, HW-05, HW-06 |
...
term. The [foundation map](../cheri-foundation-map.md) correctly retains that
