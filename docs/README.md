...
| Background and design assessment | [Inspirations and prior art](background/inspirations.md), [architectural alternatives](background/architectural-alternatives.md), [critique](background/critique.md), [static-memory research agenda](background/static-memory-research.md), [open mathematical conjectures](background/open-math-conjectures.md) |
