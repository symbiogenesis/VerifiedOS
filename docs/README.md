...
| Performance | [Performance estimates](performance/performance-estimates.md), [inference demand](performance/inference-demand.md) and its [measurement artifacts](performance/inference-demand/), [toolchain residency](performance/toolchain-residency.md) and its [measurement artifacts](performance/toolchain-residency/) |
