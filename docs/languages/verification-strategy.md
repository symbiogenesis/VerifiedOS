...
| [Soundly Handling Linearity](https://arxiv.org/abs/2307.09383), POPL 2024; [Affect](https://iris-project.org/pdfs/2025-popl-affect.pdf), POPL 2025 | Continuations that discard or duplicate their captured context interact with ownership. Affect provides an affine type/effect system with Iris-based semantic soundness mechanized in Rocq. Q25 uses these resource rules for general handlers and suspension; their language and runtime are not the selected CHERI instance, and the synchronous Q21a slice supplies no qualification of them. |
