...
A finding is something the build learned that the plan would otherwise learn again. The plan records 182 of them across 45 items and nothing read them, which costs three ways: the same fact found twice at two items, an owed act with nowhere to live until somebody assembles S1's rows out of prose by hand, and a methodological finding that never becomes a rule. This register is what reads them.
...
· Raised: M0.18
· Disposition: standing, editing the workflow being the permanent vendored divergence I4 and I8 both refuse; S14 is the disposition
## M1 · Toolchain spine
