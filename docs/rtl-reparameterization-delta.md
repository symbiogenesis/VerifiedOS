...
| Integration | `upstream/mocha`, `hw/top_chip/` | `032d6dd1`, tagged `v0.1.0` | 2026-08-23 |
...
| 146 to 155 | `cap_flags_t`, the `int_mode` bit | deletion | one mode. This is the largest single deletion in the datapath by site count, because the flag is threaded through fetch, decode, issue, commit and the CSR file (§2.4) |
