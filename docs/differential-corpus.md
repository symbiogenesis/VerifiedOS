...
| [`cap-trap`](../corpus/cap-trap.s) | eight traps through MTCC and back through MEPCC: six capability violations with their `mtval` detail, an alignment exception, and an unallocated CSR address |
