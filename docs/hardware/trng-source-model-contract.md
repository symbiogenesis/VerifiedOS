...
| a bound on cold-boot latency | R-09-006b for the constant; the product's owner for DP-7's ratification in [the product-gate contract](../implementation/contracts/product-gate-contract.md) | the constant is a register obligation and the ceiling a proposed parameter; §4 states how the budget enters the constant |
