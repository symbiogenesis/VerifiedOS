...
Multi-port cells are not mandated as a universal replacement either: their stability and minimum-voltage benefit is paid for in transistor count and density, so they remain a per-tier implementation decision rather than a platform mechanism.
