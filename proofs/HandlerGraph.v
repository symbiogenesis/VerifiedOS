...
(* =========================================================================
  ...
  10. Boolean rather than propositional wherever the witnesses must compute:
   ...
   SHA256: 722d5a48dd89e40c27930df5a6a1e384caee30887364516ee3990e3da5a3db65
   (*| END derived |*)
   ========================================================================= *)
...
Definition witness_Ambient : Ambient := demo_ambient.
Definition witness_Edge : Edge := e_decode.
Definition witness_Graph : Graph := demo_graph.
