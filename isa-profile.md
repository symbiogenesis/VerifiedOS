...
| **Software-defined permission bits** | RVY mandates a 4-bit field and CHERIoT carries them; here every permission codepoint is architecturally interpreted, and the software classification an SDP bit carries is carried by the composition-fixed 4-bit object type, enforced rather than advisory | R-15-007b, R-07-002b |
