...
| `fence` retained | for cross-island ring ordering over shared SRAM; no cache-management instruction accompanies it. The I/O and device-ordering ground is **struck** — R-15-015b plus R-15-015a's device-endpoint destination set make every device-space edge structural | R-15-017, R-15-015a, R-15-015b |
