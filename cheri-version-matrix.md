...
| Unaligned-base CHERI exception code | 8.0 | ⚠️ | R-15-084, R-15-073a | **decide** | Misaligned data accesses trap (R-15-084) and fetch is bundle-aligned, so the *behavior* is settled; what is unsettled is the cause encoding. R-15-073a fixes where a capability exception reports and leaves open whether an unaligned base reports as a CHERI cause at all or as the standard misaligned one. |
