...
**Traces are bookmarks, not line numbers.** Each entry names a `<a id="r-ss-nnn">` bookmark carried by the prose line it was extracted from, so editing the prose moves the target with the text and a trace cannot go stale. The display text is the prose section the bookmark sits in; a second citation of one requirement takes the suffix `-2`. A line number would be a derived fact restated with nothing checking it; a bookmark is not. `tools/check.ps1` holds what a symbolic reference can still violate silently (R-05-151a).
...
· Trace: CJ-CERISE, CJ-SAIL, CJ-TAL-SOUND · [§15](verification-maximal-os.md#r-15-007p)
...
· Trace: CJ-CERISE, CJ-SAIL, CJ-WCET · [§15](verification-maximal-os.md#r-15-007q)
...
· Trace: CJ-SAIL, CJ-MEMPLAN · [§15](verification-maximal-os.md#r-15-007r)
...
· Trace: CJ-LEAK, CJ-SAIL, CJ-WCET · [§15](verification-maximal-os.md#r-15-054a)
