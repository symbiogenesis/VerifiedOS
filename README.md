...
[Open standards are preferred wherever these guarantees permit them](docs/spec.md#r-04-001a). Reuse their interfaces and semantics; document a concrete conflict or an owned implementation gap before replacing them. The [OpenCL/SPIR-V and HIP source-compatibility path](docs/implementation/compute-compatibility.md) targets certified native vector/matrix code built before generation admission, with bounded runtime resources. It is planned work, and it changes none of the guarantees below.
