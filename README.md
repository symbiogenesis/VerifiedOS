...
| Self-modifying-code and instruction-stream synchronization bugs | Runtime native code generation, writable executable memory, `fence.i`, and writable-to-executable promotion are absent; same-session Wasm apps are interpreted data | **🕳️&nbsp;Absent** |
