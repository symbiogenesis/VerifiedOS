...
from vos import capformat, config, coreclass, decode, differential, figures, geometry
...
def _vectorless_configurations(ctx: Context) -> None:
...
def run(ctx: Context) -> None:
    ...
    _vectorless_configurations(ctx)
    rep.line()
